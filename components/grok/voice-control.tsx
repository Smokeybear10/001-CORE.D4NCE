    ...
    <div className="flex flex-col h-full bg-[#150535] rounded-2xl border border-violet-500/[0.12] shadow-[0_0_30px_rgba(185,103,255,0.08)] overflow-hidden">
      ...
      <div className="p-3 border-b border-violet-500/[0.1]">
        ...
        <div className="text-[10px] text-violet-100/40 bg-violet-500/[0.06] rounded px-2 py-1">
          <span className="text-violet-300">Hearing:</span> {audioDescription}
        </div>
      </div>
      ...
      <ScrollArea className="flex-1 p-3 h-full overflow-y-auto">
        <div className="space-y-3">
          ...
          {interimTranscript && (
            <div className="p-2 rounded-lg bg-violet-500/10 border border-violet-500/15 text-violet-100/80 text-xs italic ml-8">
              {interimTranscript}...
            </div>
          )}
        ...
        <div className="flex gap-2">
          <Button
            ...
            className={cn(
              ...
              isListening
                ...
                : "border-violet-500/[0.15] text-violet-100/40 hover:text-violet-300 hover:border-violet-400/40",
            )}
          >
          ...
          <form onSubmit={handleTextSubmit} className="flex-1 flex gap-2">
            ...
            <Button
              ...
              className="shrink-0 bg-gradient-to-r from-violet-500 to-violet-600"
            >
        ...
        <div className="flex flex-wrap gap-1">
          {["More bass", "Drop filter", "Fade to B", "Play", "Add reverb"].map((cmd) => (
            <button
              ...
              disabled={isLoading}
              className="px-2 py-0.5 rounded text-[10px] bg-violet-500/[0.06] text-violet-100/40 hover:text-violet-300 hover:bg-violet-500/[0.08] transition-colors disabled:opacity-50"
            >
              {cmd}
            </button>
          ))}
